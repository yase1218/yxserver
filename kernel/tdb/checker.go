...
func (t *Tdb) checkFunc(value any) (bool, []string) {
...
func (t *Tdb) checkTableBase() error {
	allErrorMsg := make([]string, 0)
	gameDbBaseValueOf := reflect.ValueOf(reflect.ValueOf(tdb).Elem().FieldByName("TableBase").Interface()).Elem()
...
func (t *Tdb) checkAllViaObj(objBeChecker any) error {
...
func (t *Tdb) hasTagCheck(v reflect.Value) bool {
...
func (t *Tdb) checkOneDataMember(v reflect.Value) error {
